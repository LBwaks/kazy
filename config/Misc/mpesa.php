...
return [
    ...
    'c2b' => [
        'sandbox' => [
            'short_code' => '600000',
            'validation_key' => 'DPxCJoBuBdTfZJDIgGomolcvxIDfUjXc',
            'confirmation_key' =>  'dCaxD9MYgBoCryI9W20VleVSxA4eV1P9',
            'consumer_secret' => 'GWVUzMoG2BiKWVsW',
            'consumer_key' => 'ihXtwtb2prGXFk9Lpj5aPCul4rDa4Y1m',
            'endpoints'=>['registration'=>'https://sandbox.safaricom.co.ke/mpesa/c2b/v1/registerurl'
            ],
        ],
        // 'sandbox' => [
